...
<section class="success" id="About">
    ...
    <div class="row">
        <div class="col-lg-4 col-lg-offset-2">
            <p>Passionnée par l'informatique depuis longtemps, j'ai décidé de suivre une formation de Développeur
                d'application PHP Symfony auprès d'OpenClassrooms</p>
        </div>
        <div class="col-lg-4">
            <p>Actuellement contrôleur en cabinet d'Expertise Comptable, je me destine à faire de l'informatique mon
                futur métier !</p>
        </div>
            ...
            <form name="sentMessage" id="contactForm" method="POST" action="<?= URL ?>sendEmail" novalidate>
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        <label>Nom</label>
                        <label for="name"></label><input name="name" type="text" class="form-control" placeholder="Nom"
                                                         id="name" required
                ...
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        ...
                        <label for="email"></label><input name="email" type="email" class="form-control"
                                                          placeholder="Adresse mail" id="email" required
                ...
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        ...
                        <label for="phone"></label><input name="phone" type="tel" class="form-control"
                ...
                <div class="row control-group">
                    <div class="form-group col-xs-12 floating-label-form-group controls">
                        <label>Message</label>
                        <label for="message"></label><textarea name="message" rows="5" class="form-control"
