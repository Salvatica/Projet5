...
<?php
if ($this->existInSession('user_name')) { // on determine si la variable user_name est définie dans la session
...
<div class="comment">
    ...
    <?php foreach ($comments as $comment) { ?> <br>
        <ul class="list-group list-group-flush">
            <li class="list-group-item"><p><h6><?= htmlspecialchars($comment->getAuthor()->getName()); ?></h6></p> à
                posté :
